  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        getApiErrorMessage(
          err,
          "Could not verify this NAFDAC number. Please try again.",
        ),
      );
    } finally {
      setLoading(false);
        ...
        >
          ...
          <View style={{ paddingHorizontal: 24 }}>
            ...
            <View style={{ alignItems: "center", marginBottom: 32 }}>
              ...
              >
                Enter the NAFDAC registration number found on the drug packaging
                  ...
                  >
                    <Text
                      style={{
                        fontSize: 13,
                        fontWeight: "700",
                        color: nafdacCode === ex ? "#fff" : "#0B1C5A",
                        letterSpacing: 1,
                      }}
                    >
                      {ex}
            ...
            <Pressable
              ...
              style={({ pressed }) => ({
                backgroundColor:
                  nafdacCode.trim() && !loading ? "#0B1C5A" : "#0B1C5A50",
                borderRadius: 18,
                paddingVertical: 18,
                flexDirection: "row",
                alignItems: "center",
