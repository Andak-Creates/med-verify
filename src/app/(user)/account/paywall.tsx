    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.subtitle}>
          You've used your 3 free scans. Upgrade to MedVerify Pro for unlimited drug verifications, instant AI safety analysis, and real-time counterfeit alerts.
        </Text>
        ...
        {isIos && appleSubscriptions.length > 0 ? (
              ...
              >
                <View style={styles.planLeft}>
                  ...
                  <Text style={styles.planDesc}>
                    Unlimited drug scans & AI safety analysis
                  </Text>
                </View>
          ...
          <View style={styles.planCard}>
            <View style={styles.planLeft}>
              ...
              <Text style={styles.planDesc}>Unlimited scans & AI verification</Text>
            </View>
            <View style={styles.planRight}>
...
const BENEFITS = [
  "Unlimited medication verification scans",
  "Instant AI active ingredients & safety analysis",
  "Real-time counterfeit & recall safety warnings",
  "Comprehensive scan history & verification records",
  "Direct counterfeit reporting to safety authorities",
];
