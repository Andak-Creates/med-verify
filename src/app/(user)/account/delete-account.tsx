    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.title}>{t.account.deleteAccount}</Text>
          <Text style={styles.subtitle}>
            This action is permanent. All your verification scan history and profile data will be permanently erased.
          </Text>

          <View style={styles.warningBox}>
            <Ionicons name="warning-outline" size={16} color="#B91C1C" style={{ marginRight: 8, marginTop: 2 }} />
            <Text style={styles.warningText}>
              {t.account.deleteConfirmMsg}
            </Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, color: '#64748B', lineHeight: 24, marginBottom: 24 },
  ...
  modalBody: { fontSize: 14, color: '#64748B', lineHeight: 22, textAlign: 'center', marginBottom: 24 },
