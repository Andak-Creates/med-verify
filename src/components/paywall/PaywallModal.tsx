      ...
      <View style={styles.backdrop}>
        <View style={styles.container}>
          ...
          <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.headline}>Unlock Full Drug Safety & Verification Power</Text>
            <Text style={styles.subheadline}>
              Access unlimited medication scans, real-time AI composition checks, and instant counterfeit detection alerts.
            </Text>
            ...
            <View style={styles.featuresList}>
              <View style={styles.featureItem}>
                ...
                <Text style={styles.featureText}>Unlimited Drug Verification Scans</Text>
              </View>
              <View style={styles.featureItem}>
                <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                <Text style={styles.featureText}>AI-Powered Composition & Safety Analysis</Text>
              </View>
              <View style={styles.featureItem}>
                <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                <Text style={styles.featureText}>Real-Time Counterfeit & Recall Warnings</Text>
              </View>
              <View style={styles.featureItem}>
                <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                <Text style={styles.featureText}>Complete Scan History & Verification Archive</Text>
              </View>
              <View style={styles.featureItem}>
                <Ionicons name="checkmark-circle" size={20} color="#10B981" />
                <Text style={styles.featureText}>Direct Counterfeit Reporting with Batch Tracking</Text>
              </View>
            </View>
